...
void idSessionLocal::Frame() {
	...
	// [UWP]: Brought in tic smoothing logic from doom3quest commit 6355e3ba4880a173babbaae7a579f8da622e8f91
	//
	...
	int fps = calcFPS();
	bool skipTics = false;
	if (com_skipTics.GetBool() && numCmdsToRun > 1) {
		int refresh = USERCMD_HZ;//advo, was renderSystem->GetRefresh()
