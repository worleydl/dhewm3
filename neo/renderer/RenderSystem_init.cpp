...
idCVar r_gamma( "r_gamma", "1.7", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_FLOAT, "changes gamma tables", 0.5f, 3.0f );
...
void R_InitOpenGL( void ) {
	...
	for ( i = 0 ; i < 2 ; i++ ) {
		...
		glConfig.vidWidth = 3140;
		glConfig.vidHeight = 2160;

		parms.width = glConfig.vidWidth;
		parms.height = glConfig.vidHeight;
		parms.fullScreen = true; // r_fullscreen.GetBool();
		parms.fullScreenDesktop = true; //r_fullscreenDesktop.GetBool();
